...
public class DBContext {
    ...
    public static void initResourcesByUserName(String userName) {
        ...
        logger.debug("   ====> init AppResources by userName: " + userName + ", tenant = " + getTenant().getSchemaName());
    ...
    public static void initResourcesByToken(String token) {
        ...
        logger.debug("   ====> init AppResources by token: " + token + ", tenant = " + getTenant().getSchemaName());
