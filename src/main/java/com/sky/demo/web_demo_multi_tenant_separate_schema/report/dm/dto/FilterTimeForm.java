...
public class FilterTimeForm
implements Serializable {
    private static final long serialVersionUID = -653621453519075978L;
    ...
    public String toString() {
        return Objects.toStringHelper((Object)this).add("enableFilter", this.enableFilter).add("timeType", (Object)this.timeType).add("preciseFrom", (Object)this.preciseFrom).add("preciseTo", (Object)this.preciseTo).add("lastPastDay", (Object)this.lastPastDay).add("timePointOn", this.timePointOn).add("timePointFrom", (Object)this.timePointFrom).add("timePointTo", (Object)this.timePointTo).toString();
    }
}
